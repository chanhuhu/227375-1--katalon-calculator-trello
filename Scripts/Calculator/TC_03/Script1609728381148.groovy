...
for (def index : (0..10)) {
    ...
    WebUI.click(findTestObject('Page_calculator -  Google/div_1'))

    WebUI.click(findTestObject('Page_calculator -  Google/div_minus'))
}

WebUI.click(findTestObject('Page_calculator -  Google/div_equal'))

WebUI.verifyElementText(findTestObject('Page_calculator -  Google/div_output'), '10')
