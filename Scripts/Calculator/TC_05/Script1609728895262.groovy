...
WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_Inv'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_Rnd'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_Ans'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_Ans'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_Ans'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_'))

WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div__1'))

WebUI.verifyElementText(findTestObject('Page_calculator -  Google/div_output'), '0')
