...
for (def index : (1..10)) {
    WebUI.click(findTestObject('Object Repository/Page_calculator -  Google/div_EXP'))
...
WebUI.verifyElementText(findTestObject('Page_calculator -  Google/div_output'), '10000000000')
